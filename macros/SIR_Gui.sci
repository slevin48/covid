function SIR_Gui()
    ...
    uicontrol(my_frame, ...
        "style", "text", ...
        "position",[l1,guih1-260+guih1o,l2,90], ...
        "string", "$\dot{s} = - \gamma*s(t)*i(t), \\ \dot{i} = - \gamma*s(t)*i(t) - \beta*i(t), \\ \dot{r} = \beta*i(t) $", ...
        "tag", "equations");

   uicontrol(my_frame, ...
       "style", "image", ...
       "position",[l1,guih1-400+guih1o,l2,130], ...
       "string", "images\epidemy.png", ...
       "tag", "img_model");
